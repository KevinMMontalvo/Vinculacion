...
export default class StudentForm extends React.Component
{
	...
	ChekWarningMessages()
	{
		...
		studentsController.studentInsert();
	}
		...
		return (<div>
			<div className="student-form">
				...
				<div className="form-container">
					...
					<div className="input-container">
						<input maxlength="2" onKeyPress={() => this.ValidateOnlyNumbers(event)} placeholder="%"
				...
				<div className="button-container">
					<div onClick={() => this.ChekWarningMessages()} className="secondary-button">Completar
						Registro
					</div>
				</div>
